...
declare -A CORES_MAP=(
    ...
    ["psx.so"]="mednafen_psx_libretro.so.zip"
    ["saturn.so"]="mednafen_saturn_libretro.so.zip"
    ["dreamcast.so"]="flycast_libretro.so.zip"
    ["psp.so"]="ppsspp_libretro.so.zip"
    ["gamecube.so"]="dolphin_libretro.so.zip"
    ["3ds.so"]="citra_libretro.so.zip"
    ["neocd_alt.so"]="neocd_libretro.so.zip"
    ["neocd.so"]="neocd_libretro.so.zip"
    ["ps2.so"]="pcsx2_libretro.so.zip"
    ["ps2_play.so"]="play_libretro.so.zip"
