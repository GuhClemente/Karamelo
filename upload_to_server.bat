...
echo   - %LOCAL_JSON%
set EXTRA_FILES=
if exist "%~dp0dist\MiSTer_4_ALL_Pack_BIOS.zip" (
    set EXTRA_FILES="%~dp0dist\MiSTer_4_ALL_Pack_BIOS.zip"
    echo   - dist\MiSTer_4_ALL_Pack_BIOS.zip
)
...
if errorlevel 1 (
    ...
    if exist "%~dp0dist\MiSTer_4_ALL_Pack_BIOS.zip" echo   - https://mister4all.com/downloads/MiSTer_4_ALL_Pack_BIOS.zip
    echo =======================================================
)
