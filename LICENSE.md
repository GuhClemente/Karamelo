...
Required Notice: Copyright 2026 Gustavo Clemente (https://karamelo-emu.com)
...
* O código de terceiros vendorizado em `third_party/`, que continua sob as
  licenças originais de cada projeto. O `n64_gopher.dll` em particular é
  compilado do gopher64, que é **GPL-3.0** — a licença dele vale para ele,
  não para este projeto.
* Os cores libretro distribuídos em `cores/`. São binários independentes de
  terceiros, cada um sob a licença do seu próprio projeto.
