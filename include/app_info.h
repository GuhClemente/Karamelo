...
#define APP_ARCH     "x64"
#define APP_EXE_BASE "MiSTer_Flavor"
#define APP_EXE_NAME "MiSTer_Flavor_v2.0.exe"
// The OSD value column cuts at 13 characters, so the About row uses a short
// form; this full one is for anywhere with room.
